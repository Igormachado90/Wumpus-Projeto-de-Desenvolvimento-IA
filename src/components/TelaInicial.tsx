...
export function TelaInicial({ jogo }: Props) {
  ...
  if (tela === 'transicao') {
    return (
      <main className="tela-inicial tela-transicao">
        ...
        <img className="tela-logo tela-logo-transicao" src={`${import.meta.env.BASE_URL}imagnes/logo.png`} alt="Wumpus Exterminador" />
  ...
  if (tela === 'configuracoes') {
    return (
      <main className="tela-inicial tela-configuracoes">
        <img className="tela-logo tela-logo-pequeno" src={`${import.meta.env.BASE_URL}imagnes/logo.png`} alt="Wumpus Exterminador" />
  ...
  return (
    <main className="tela-inicial tela-menu">
      ...
      <img className="tela-logo" src={`${import.meta.env.BASE_URL}imagnes/logo.png`} alt="Wumpus Exterminador do Futuro" />
